...
# training options
parser.add_argument('--root', type=str, default='../Asi_maskiert/Chris_Daten')
parser.add_argument('--mask_root', type=str, default='../Asi_maskiert/original_masks/Maske_Chris.hdf5')
