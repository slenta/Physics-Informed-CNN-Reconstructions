...
from .utils.evaluation import infill, get_batch_size, get_xr_dss
...
def evaluate(arg_file=None, prog_func=None):
    ...
    eval_path = [
        "{}/{}".format(cfg.evaluation_dirs[0], name) for name in cfg.eval_names
    ]
    output_names = {}
    count = 0
    for i_model in range(n_models):
        ...
        ckpt_dict = load_ckpt(
            "{}/{}.pth".format(cfg.model_dir, cfg.model_names[i_model]), cfg.device
        )
