...
evalu.compare_datasets(path_1=cfg.mask_dir + cfg.mask_name + cfg.eval_mask_year  + '_' +  cfg.attribute_depth + '_' + cfg.attribute_anomaly + '_' + cfg.attribute_argo + '_' + str(cfg.in_channels) + '_observations.hdf5',
